...
import { ListNotificationScheduleController } from './list-notification-schedule.controller'
...
const usecase = mock<ListNotificationScheduleUseCaseInterface>()
const fakeOutput = {
  id: 'anyId',
...
describe('UpdateNotificationScheduleController', () => {
  let sut: ListNotificationScheduleController
  let input: HttpRequest

  beforeEach(() => {
    sut = new ListNotificationScheduleController(usecase)
    input = {
      body: {
        type: 'whatsapp' as NotificationTypes,
