...
O **Desafio backend Magalu** é um desafio backend feito pela instituição. A ideia é construir uma plataforma que faça parte de uma plataforma de comunicação, com isso precisamos:
...
- A solução deverá ser uma api RESTFULL.
- Pode utilizar qualquer linguagem de programação.
- O banco de dados pode ser MYSQL ou POSTGRESQL.
